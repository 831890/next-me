      ...
      <div>
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          <Link href="/" className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <svg className="w-6 h-6 text-amber-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            <span className="ml-3 text-xl">김중앙의 포트폴리오</span>
          </Link>
          <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">
            © 2024 —
            <a href="https://open.kakao.com/o/skqeeOkg" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">
              Juah
            </a>
          </p>
